...
2025-12-08 22:14:12 | C/Ft_turing | IN_PROGRESS | Blank désormais obligatoire (erreurs si manquant/multicaractère), usage CLI mis à jour (-t), nouveau cas de test `invalid_missing_blank.tm` ajouté (suite 9/9), docs format/exemples/README rafraîchies.
