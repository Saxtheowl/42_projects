...
2025-12-08 22:39:03 | C/Ft_turing | IN_PROGRESS | Option -r pour afficher la raison d'arrêt (accept/transition manquante/max steps), nouveau test d'exécution sur machine incomplète, suite portée à 15 cas; docs format/exemples/README mis à jour.
