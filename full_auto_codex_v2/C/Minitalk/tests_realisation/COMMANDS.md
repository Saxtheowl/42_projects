...
- `./scripts/run_tests.sh` — exécute la batterie automatisée : compilation, démarrage serveur isolé, envoi de messages (non vide, vide, ponctuation, rafale) et vérification du log généré.
