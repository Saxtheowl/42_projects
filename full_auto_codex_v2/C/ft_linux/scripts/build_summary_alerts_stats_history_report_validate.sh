...
JSON_FILE="$REPORT_DIR/build_summary_alerts_stats_history_report.json"
OUT_TXT="$REPORT_DIR/build_summary_alerts_stats_history_report_validate.txt"

usage() {
	cat <<USAGE
Usage: $0 [--report <file>] [--json <file>] [--out <file>]

Valide le rapport historique stats alertes.
USAGE
	exit 1
}
...
{
	echo "build_summary_alerts_stats_history_report_validate generated: $(date '+%Y-%m-%d %H:%M:%S')"
...
echo "[OK] Build summary alerts stats history report validate generated: $OUT_TXT"
