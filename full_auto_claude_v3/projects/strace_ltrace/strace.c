/* ************************************************************************** */
/*                                                                            */
/*   strace/ltrace - System Call and Library Call Tracer                     */
/*   Trace program execution using ptrace                                     */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (num >= 0 && (size_t)num < SYSCALL_COUNT && syscall_names[num])
...
void trace_syscalls(pid_t child)
{
    ...
    while (1)
    {
        ...
        if (!in_syscall)
        {
            ...
            fprintf(stderr, "%s(", get_syscall_name(syscall_num));
...
int main(int argc, char **argv, char **envp)
{
    ...
    if (argc < 2)
    {
        fprintf(stderr, "ft_strace - System Call Tracer\n\n");
        fprintf(stderr, "Usage: %s <command> [args...]\n", argv[0]);
        fprintf(stderr, "\nExample:\n");
        fprintf(stderr, "  %s /bin/ls -la\n", argv[0]);
        fprintf(stderr, "  %s /bin/echo hello\n", argv[0]);
        return 1;
    }
